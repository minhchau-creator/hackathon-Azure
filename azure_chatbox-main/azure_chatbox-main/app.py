...
def get_response():
    ...
    response = client.chat.completions.create(
        model="GPT35TURBO16K",
        messages = [
            {"role": "system", "content": "you are an English assistant and you can only respond in English"},
            {"role": "assistant", "content": "Hello, I'm your English assistant. How can I help you today ?"},
